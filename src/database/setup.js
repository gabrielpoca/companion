...
export const COUCHDB_URL = url.parse(process.env.COUCHDB_URL);
COUCHDB_URL.auth = `${process.env.COUCHDB_USER}:${process.env.COUCHDB_PASSWORD}`;

const n = Nano(COUCHDB_URL.format());

export const db = n.db;
...
export const setup = async () => {
  ...
  try {
    ...
    try {
      ...
      console.log("failed to setup _users _design/_auth");
    }
